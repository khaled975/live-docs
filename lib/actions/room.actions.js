...
export const getDocument = async ({ roomId, userId }) => {
  try {
    ...
    console.log(`Error happened while getting room ${error.message}`);
  }
};
export const getAllDocuments = async (email) => {
  try {
    ...
    console.log(`Error happened while getting all rooms ${error.message}`);
  }
};
...
export const updateDocument = async (roomId, title) => {
  try {
    ...
    console.log(`Error happened while updating Room Title ${error.message}`);
  }
};
...
export const updateDocumentAccess = async ({
  ...
  try {
    ...
    console.log(
      `Error happened while updating document Access ${error.message}`
    );
  }
};
...
export const removeUserFromDocument = async ({ roomId, email }) => {
  try {
    ...
    console.log(`Error happened while removing user's access ${error.message}`);
  }
};
...
export const deleteDocument = async ({ roomId }) => {
  try {
    ...
    console.log(`Error happened while deleting the document ${error.message}`);
  }
};
